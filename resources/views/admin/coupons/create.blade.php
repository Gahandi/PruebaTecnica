    ...
    <div class="p-4 md:p-6">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600">Define un nuevo código de descuento</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="code" id="code" required
                            ...
                            placeholder="DESCUENTO20" value="{{ old('code') }}">
                        @error('code')
                ...
                <div>
                    ...
                    <select name="spaces_id" id="spaces_id"
                        ...
                        @foreach($spaces as $space)
                            <option value="{{ $space->id }}" {{ old('spaces_id') == $space->id ? 'selected' : '' }}>
                                {{ $space->name }}</option>
                        @endforeach
                    </select>
                    <p class="text-xs text-gray-500 mt-1">Si no seleccionas un espacio, el cupón será válido para todos.</p>
                </div>
