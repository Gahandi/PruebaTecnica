...
@section('title', 'Sistema de Check-in')
...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Sistema de Check-in</h1>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <!-- Filter by Event -->
                        <form method="GET" action="{{ route('admin.checkins.index') }}" class="flex items-center space-x-2">
...
function scanQR() {
    ...
    fetch('{{ route("admin.checkins.store") }}', {
        method: 'POST',
        headers: {
