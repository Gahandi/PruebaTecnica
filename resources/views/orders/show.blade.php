                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">
                            {{ \Carbon\Carbon::parse($order->event->date)->format('l, d F Y \a \l\a\s H:i') }}</p>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mt-2 grid grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <span
                                                class="font-medium text-green-600">${{ number_format($item->quantity * $item->price, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="space-y-3">
                    ...
                    @if($order->coupon)
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-medium text-red-600">-${{ number_format(($order->total - $order->taxes) * ($order->coupon->discount_percentage / 100), 2) }}</span>
                        </div>
                    @endif
                    <div class="flex justify-between">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach($order->tickets as $ticket)
                    <div class="border border-gray-200 rounded-lg p-4 text-center">
                        ...
                        <div class="mt-3">
                            <a href="{{ $ticket->qr_url }}" target="_blank" class="text-blue-600 hover:text-blue-900 text-sm">
                                Descargar QR
                            </a>
                        </div>
                    </div>
