                                    ...
                                    <div class="bg-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 border-2 border-transparent hover:border-pink-200 h-full flex flex-col">
                                        <div class="relative overflow-hidden flex-shrink-0">
                                            ...
                                            <div class="absolute top-4 right-4">
                                                <span class="bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 sm:px-4 py-1.5 rounded-full text-xs font-bold shadow-lg backdrop-blur-sm">
                                                    ⭐ Destacado
                                                </span>
                                            </div>
                                        </div>
                                        <div class="p-4 sm:p-6 flex flex-col flex-grow">
                                            <h3 class="text-lg sm:text-xl font-bold text-[#e24972] mb-2 line-clamp-2">{{ $event->name }}</h3>
                                ...
                                @if($event->ticketTypes->count() > 0)
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="w-full bg-gray-200 rounded-full h-2.5">
                                            <div class="bg-gradient-to-r from-green-500 to-emerald-500 h-2.5 rounded-full transition-all duration-300" style="width: {{ $porcentaje }}%"></div>
                                        </div>
                                    </div>
                                @endif
