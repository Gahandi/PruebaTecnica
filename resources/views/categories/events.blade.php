            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                @foreach($events as $event)
                    <a href="{{ \App\Helpers\SubdomainHelper::getSubdomainUrl($event->space->subdomain) }}/{{ $event->slug }}"
                        class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group block">
                        <div class="relative aspect-square overflow-hidden">
                            ...
                            @else
                                <div
                                    class="w-full h-full bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center">
                        ...
                        <div class="p-3">
                            <h3
                                class="text-sm font-bold text-gray-900 mb-1 line-clamp-2 group-hover:text-[#e24972] transition-colors">
                                {{ $event->name }}</h3>
