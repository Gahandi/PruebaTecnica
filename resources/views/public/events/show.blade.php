            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <form id="purchaseForm" class="space-y-6">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <input type="number" id="quantity_{{ $ticketType->id }}"
                                                name="tickets[{{ $loop->index }}][quantity]" value="0" min="0"
                    ...
                    <div class="border-t pt-6">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div id="order_summary" class="space-y-2">
                                ...
                                <div class="flex justify-between text-sm">
                                    <span>{{ \App\Helpers\SettingsHelper::getServiceChargeName() }}
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button type="button" id="view_cart_button" onclick="window.location.href='{{ route('cart') }}'"
