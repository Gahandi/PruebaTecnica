...
<body>
    ...
    <div class="content">
        <div class="order-info">
            ...
            @endif
            <div class="info-row">
                <span class="info-label">{{ \App\Helpers\SettingsHelper::getServiceChargeName() }}
                    ({{ \App\Helpers\SettingsHelper::getServiceChargePercentage() }}%):</span>
                <span class="info-value">${{ number_format($order->taxes, 2) }} MXN</span>
            </div>
            <div class="info-row"
                style="font-size: 18px; font-weight: bold; border-top: 2px solid #e5e7eb; padding-top: 15px; margin-top: 10px;">
        ...
        <div class="tickets-list">
            ...
            <p>Se han adjuntado los PDFs de tus boletos a este correo. Cada boleto incluye un código QR único para el
                acceso al evento.</p>
        ...
        <div
            style="background: #fef3c7; border: 1px solid #f59e0b; border-radius: 6px; padding: 15px; margin-top: 20px;">
