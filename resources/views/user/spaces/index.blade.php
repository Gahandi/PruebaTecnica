...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-[#e24972]">Mi Cajón de Eventos</h1>
                <p class="text-gray-600 mt-1">Gestiona tu cajón de eventos</p>
            </div>
            <div class="flex space-x-3">
                @if($spaces->count() == 0)
                    <a href="{{ route('user.spaces.create') }}" 
                       class="bg-gradient-to-r from-pink-500 to-pink-400 hover:from-pink-600 to-pink-500 text-white px-4 py-2 rounded-lg transition-colors flex items-center">
