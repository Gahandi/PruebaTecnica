...
<div class="max-w-2xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow-xl rounded-xl p-8 border border-gray-100">
        <form method="POST"
            action="{{ route('user.spaces.store') }}"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="text" name="subdomain" id="subdomain"
                            value="{{ old('subdomain') }}" readonly
                            class="flex-1 border border-gray-300 rounded-l-lg px-4 py-3 bg-gray-50 text-gray-600">
                        <span class="inline-flex items-center px-3 border border-l-0 border-gray-300
                                    bg-gray-50 text-gray-500 rounded-r-lg">
                            .{{ config('app.url') }}
                        </span>
                    </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Formato recomendado: PNG o JPG</p>
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="banner"
                        ...
                        class="w-full border border-gray-300 rounded-lg px-4 py-3
                            focus:ring-blue-500 focus:border-blue-500
                            @error('banner') border-red-500 @enderror">

                    @error('banner')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror

                    <p class="text-xs text-gray-500 mt-1">Formato recomendado: Horizontal 1200x400px</p>
                </div>
