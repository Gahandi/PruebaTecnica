...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Crear Cupón</h1>
            <p class="text-sm sm:text-base text-gray-600 mt-1">Crea un nuevo cupón de descuento para {{ $space->name }}</p>
        </div>
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <form method="POST" action="{{ route('spaces.coupons.store', $space->subdomain) }}" class="p-4 sm:p-6">
            @csrf
