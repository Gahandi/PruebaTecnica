...
<div>
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Visualiza todas las órdenes de tus eventos</p>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-pink-500 to-pink-600">
                    <tr>
                        ...
                        <th class="px-4 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Evento</th>
                        ...
                        <th class="px-4 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Estado</th>
                        <th class="px-4 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Fecha</th>
                            ...
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <p class="text-xs text-gray-500">{{ $order->user->email ?? 'Sin email' }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-4">
