...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Fix para asegurar que el contenido se actualice en el textarea antes del envío (aunque EasyMDE suele hacerlo)
            document.querySelector('form').addEventListener('submit', function () {
                // Forzar actualización de textareas originales
                // Esto es por seguridad, EasyMDE debería hacerlo on change
            });
        });
    </script>
