        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    ...
                    <input id="email" name="email_display" type="email" autocomplete="email" required
                           class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm bg-gray-50"
                           value="{{ $email }}" disabled>
                    <p class="mt-1 text-xs text-gray-500 px-3">Correo electrónico asociado</p>
                </div>
