                        ...
                        <dl class="space-y-4">
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between">
                                    ...
                                    <dd class="text-base font-bold text-gray-900">${{ number_format($order->total, 2) }}
                                    </dd>
                                </div>
                            </div>
                        </dl>
                            ...
                            @foreach($order->tickets as $ticket)
                                <div class="text-center">
                                    <div class="bg-gray-100 p-4 rounded-lg mb-2">
                                        ...
                                        <div
                                            class="w-20 h-20 mx-auto bg-white rounded border-2 border-gray-200 flex items-center justify-center">
