                        ...
                        <dl class="grid grid-cols-1 gap-6">
                            ...
                            @if($order->coupon)
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $order->coupon->code }}
                                        ({{ $order->coupon->discount_percentage }}% descuento)</dd>
                                </div>
                            @endif
                            <div>
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">
                                                {{ \Carbon\Carbon::parse($item->ticketType->event->date)->format('d/m/Y H:i') }}
                                            </p>
                                            <p class="text-sm text-gray-500">{{ $item->ticketType->event->location }}</p>
                                        </div>
                                        <div class="text-right">
                                            <p class="text-sm text-gray-900">{{ $item->quantity }} x
                            ...
                            @foreach($order->tickets as $ticket)
                                <div class="text-center">
                                    <div class="bg-gray-100 p-4 rounded-lg mb-2">
                                        ...
                                        <div
                                            class="w-24 h-24 mx-auto bg-white rounded border-2 border-gray-200 flex items-center justify-center">
