            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
                ...
                <div class="h-32 bg-gradient-to-r from-pink-500 to-pink-600 flex items-center justify-center text-white">
                    <div class="text-center">
                        ...
                        <p class="text-sm opacity-90">{{ \Carbon\Carbon::parse($ticket->event->date)->format('d/m/Y H:i') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $ticket->used ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                        ...
                        @if($ticket->used)
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-semibold text-red-600">{{ \Carbon\Carbon::parse($ticket->updated_at)->format('d/m/Y H:i') }}</span>
                            </div>
                        @endif
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-semibold">{{ \Carbon\Carbon::parse($ticket->created_at)->format('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-lg">
                                {{ \Carbon\Carbon::parse($ticket->event->date)->locale('es')->isoFormat('dddd, D [de] MMMM [de] YYYY [a las] HH:mm') }}
                            </p>
                        </div>
